...
크론이나 편성 데스크에서 이 형식의 .md를 POST /api/ingest 하면 DB에 올라갑니다.

## 요약

frontmatter + 한 줄 시사점 + 요약 본문. 같은 source_url은 중복 저장되지 않습니다. 런타임 소스는 Postgres(미리보기는 메모리)이고, 마크다운은 편성 입력 포맷입니다.
